...
export const gridStyle = {
    ...
    paginationButton: 'ml-2 px-2 py-1 my-2 border rounded border-gray-400 dark:border-gray-600 hover:bg-gray-200 text-gray-700 dark:text-gray-300 dark:hover:bg-gray-700',
    paginationButtonNext: 'hover:bg-gray-200 text-gray-700 dark:text-gray-300 dark:hover:bg-gray-700  dark:border-blue-500 border-1',
    paginationButtonCurrent: 'bg-blue-300 dark:text-white dark:bg-blue-600',
    paginationButtonPrev: 'hover:bg-gray-200 text-gray-700 dark:text-gray-300 dark:hover:bg-gray-700 dark:border-blue-500 border-1',
